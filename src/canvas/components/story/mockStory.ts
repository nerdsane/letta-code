...
export const mockStory: StoryData = {
  ...
  title: "The Resonance",
  subtitle:
    "In a world where emotions became visible light, one woman discovers the color of grief is not what anyone expected.",
...
But Maya's light was different. It always had been.`,
    },
    {
      ...
      content:
        "In 2087, a quantum cascade event fundamentally altered human neurology. Emotional states now generate visible electromagnetic signatures in the 380-700nm wavelength range—literally making feelings glow.",
    },
    {
      type: "text",
...
"I don't know yet." Kira's honesty was as visible as her words, her aura steady and clear. "But I think it might be important. The Council has been monitoring unusual Resonance patterns for months now. There are others like you—not many, but enough to form a pattern."`,
    },
    {
      ...
      content:
        'Lead researcher at the Institute of Emotional Sciences. Known for her groundbreaking work on Resonance anomalies. Her aura signature is unusually stable, earning her the nickname "The Constant."',
    },
    {
      type: "text",
...
Maya's grandmother had known. Somehow, impossibly, she had known.`,
    },
    {
      ...
      content:
        'Pre-Resonance materials are preserved in special vaults that block emotional interference. These "quiet rooms" are the only places where historical documents remain unaffected by the ambient emotional radiation of modern humans.',
    },
    {
      type: "text",
