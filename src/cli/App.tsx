      ...
      if (aliasedMsg.startsWith("/")) {
        ...
        if (msg.trim() === "/link" || msg.trim().startsWith("/link ")) {
          ...
          buffersRef.current.byId.set(cmdId, {
            ...
            id: cmdId,
            input: msg,
            output: "Attaching Deep Sci-Fi tools...",
            phase: "running",
          });
          buffersRef.current.order.push(cmdId);
          refreshDerived();
        ...
        if (msg.trim() === "/unlink" || msg.trim().startsWith("/unlink ")) {
          ...
          buffersRef.current.byId.set(cmdId, {
            ...
            id: cmdId,
            input: msg,
            output: "Removing Deep Sci-Fi tools...",
            phase: "running",
          });
          buffersRef.current.order.push(cmdId);
          refreshDerived();
...
The messages below were generated by the user while running local commands using "bash mode" in the Deep Sci-Fi CLI tool.
